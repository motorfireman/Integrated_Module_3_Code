...
(function($) {
    ...
    versionSelect.on('change', function() {
		body.attr('data-theme-version', this.value);
		 if(this.value === 'dark'){
             ...
             jQuery(".nav-header .logo-abbr").attr("src", "/mediqu/images/logo-white.png");
             jQuery(".nav-header .logo-compact").attr("src", "/mediqu/images/logo-text-white.png");
             jQuery(".nav-header .brand-title").attr("src", "/mediqu/images/logo-text-white.png");
			
             setCookie('logo_src', '/mediqu/images/logo-white.png');
             setCookie('logo_src2', '/mediqu/images/logo-text-white.png');
		}else{
             jQuery(".nav-header .logo-abbr").attr("src", "/mediqu/images/logo.png");
             jQuery(".nav-header .logo-compact").attr("src", "/mediqu/images/logo-text.png");
             jQuery(".nav-header .brand-title").attr("src", "/mediqu/images/logo-text.png");
			
             setCookie('logo_src', '/mediqu/images/logo.png');
             setCookie('logo_src2', '/mediqu/images/logo-text.png');
		} 
	...
	jQuery('#theme_direction').on('change',function(){
        if (html.attr('dir') === "rtl") {
            jQuery('.main-css').attr('href','/mediqu/css/style-rtl.css');
        } else {
			jQuery('.main-css').attr('href','/mediqu/css/style.css')
		}
    ...
    jQuery("#nav_header_color_1").on('click', function () {
        jQuery(".nav-header .logo-abbr").attr("src", "mediqu/images/logo.png");
        jQuery(".nav-header .logo-compact, .nav-header .brand-title").attr("src", "/mediqu/images/logo-text.png");
        setCookie('logo_src', '/mediqu/images/logo.png');
        setCookie('logo_src2', '/mediqu/images/logo-text.png');
		return false;
    });
    ...
    jQuery("#nav_header_color_2, #nav_header_color_3, #nav_header_color_4, #nav_header_color_5, #nav_header_color_6, #nav_header_color_7, #nav_header_color_8, #nav_header_color_9, #nav_header_color_10, #nav_header_color_11, #nav_header_color_12, #nav_header_color_13, #nav_header_color_14, #nav_header_color_15").on('click', function () {
        jQuery(".nav-header .logo-abbr").attr("src", "/mediqu/images/logo-white.png");
        jQuery(".nav-header .logo-compact, .nav-header .brand-title").attr("src", "/mediqu/images/logo-text-white.png");
        setCookie('logo_src', '/mediqu/images/logo-white.png');
        setCookie('logo_src2', '/mediqu/images/logo-text-white.png');
		return false;
    });
